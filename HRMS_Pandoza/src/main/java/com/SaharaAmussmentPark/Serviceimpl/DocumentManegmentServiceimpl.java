...
public class DocumentManegmentServiceimpl implements DocumentManegmentService {
	...
	@Override
	public Map<String, Object> uploadDocuments(MultipartFile adharCard, MultipartFile panCard,
			MultipartFile experianceLetter, MultipartFile salarySlip1, MultipartFile salarySlip2,
			MultipartFile salarySlip3, MultipartFile bankStatement, MultipartFile relevingLetter,
		...
		try {
			...
			if (latestEducationCertificateOrDegree != null && !latestEducationCertificateOrDegree.isEmpty())
				documents.setLatestEducationCertificateOrDegree(
						uploadFile(latestEducationCertificateOrDegree, folderName, "educationCertificate"));
	...
	@Override
	public Map<String, Object> updateDocuments(MultipartFile adharCard, MultipartFile panCard,
			MultipartFile experianceLetter, MultipartFile salarySlip1, MultipartFile salarySlip2,
			MultipartFile salarySlip3, MultipartFile bankStatement, MultipartFile relevingLetter,
			MultipartFile tenthCertificate, MultipartFile twelfthCertificate, MultipartFile degreeCertificate,
			MultipartFile latestEducationCertificateOrDegree, MultipartFile employeeImage,
	...
	public Map<String, Object> getDocuments(String employeeId) {
		...
		try {
			...
			documentsDto.setLatestEducationCertificateOrDegree(
					convertToSecureUrl(documents.getLatestEducationCertificateOrDegree()));
